...
<figure class="diagram transition-diagram">
  ...
  <div class="transition-inputs compact-transition">
    <div class="diagram-box">Previous Evidence</div>
    <div class="diagram-plus">+</div>
    <div class="diagram-box">Destination Requirements</div>
  </div>
  <div class="diagram-arrow" aria-hidden="true"></div>
  <div class="diagram-box wide">RequirementDelta</div>
  <div class="diagram-arrow" aria-hidden="true"></div>
  <div class="diagram-box wide">Reuse still-sufficient evidence</div>
  <div class="diagram-arrow" aria-hidden="true"></div>
  <div class="diagram-box wide">Requalify changed / unresolved guarantees</div>
  <div class="diagram-arrow" aria-hidden="true"></div>
  <div class="diagram-box wide">Updated AdmissionProfile</div>
</figure>
"""
...
<div class="title-meta"><div>Revision 0.1&nbsp;&nbsp;|&nbsp;&nbsp;September 2026</div><div>SPP 0.3.0 Experimental Preview</div><div>Experimental / Pre-standardization</div><div>placeauth.org</div></div>
...
<tr><th>Project</th><td>PlaceAuth</td></tr><tr><th>Author</th><td>Braden Russell Glasgow</td></tr><tr><th>Role</th><td>Project Lead, PlaceAuth</td></tr><tr><th>Protocol</th><td>Spatial Policy Protocol (SPP)</td></tr><tr><th>Current release</th><td>SPP 0.3.0 Experimental Preview</td></tr>
